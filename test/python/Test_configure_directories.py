...
class TestDirectoriesManager(unittest.TestCase):
    ...
    def tearDownClass(cls):
        ...
        shutil.rmtree(cls.directory_manager.get_directory('output'))
    ...
    def test_singleton(self):
        ...
        # test: whether it refers to the same instance
    ...
    def test_default_directories_created(self):
        ...
        self.test_get_directory_exists('output')
        self.test_get_directory_exists('logs')
        self.test_get_directory_exists('results')
    ...
    def test_make_directory_location_correctness(self):
        ...
        path = Path(self.directory_manager.get_directory('temp_dir_location_test'))
        self.assertEqual(Path(self.directory_manager.get_directory('output')), path.parent)
        shutil.rmtree(temp_dir)  # clean up
